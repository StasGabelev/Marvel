...
// Slider
    ...
    next.addEventListener('click', () => {
        if (offset == transformStr(width) * (slides.length -1)){
            offset = 0;
        } else {
            offset += transformStr(width);
        }
    ...
    prev.addEventListener('click', () => {
        if (offset == 0){
            offset = transformStr(width) * (slides.length -1);
        } else {
            offset -= transformStr(width);
        }
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = transformStr(width) * (slideTo -1);
